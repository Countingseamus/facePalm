...
def real_time_analysis():
    return DeepFace.stream(db_path='database', model_name='VGG-Face', detector_backend='opencv', distance_metric='cosine', enable_face_analysis=True, source=0, time_threshold=2, frame_threshold=2)
